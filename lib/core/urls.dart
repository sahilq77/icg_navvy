class Networkutility {
  ...
  static String getBloodGroup = "${baseUrl + "bloodGroup/v1"}";
  static int getBloodGroupApi = 2;
  static String getRank = "${baseUrl + "v1/idName/"}";
  static int getRankApi = 3;
  static String getServiceDetails = "${baseUrl + "v1/idName"}";
  ...
  static String getMedicalCategory =
      "${baseUrl + "v1/idName/filter?dataKey=MEDCAT"}";
