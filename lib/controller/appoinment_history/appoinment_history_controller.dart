...
class AppoinmentHistoryController extends GetxController {
  var appointments = <AppoinmentHistoryModel>[].obs;
  ...
  void loadDummyData() {
    appointments.assignAll([
      AppoinmentHistoryModel(
        ...
        gender: 'Female',
        status: 'Approved',
        type: 'OPD AppoinmentHistoryModel',
      ...
      AppoinmentHistoryModel(
        ...
        gender: 'Male',
        status: 'Processed',
        type: 'AME/PME AppoinmentHistoryModel',
        hospital: 'City General Hospital',
