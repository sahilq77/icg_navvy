...
class UnitController extends GetxController {
  ...
  static UnitController get to => Get.find();
    ...
    try {
      ...
      List<GetUnitResponse>? response =
          await Networkcall().getMethod(
                ...
                "https://aasha-demo.epps-erp.in/me/aasha/v1/idName/filter?personalNumber=75727-F&roleCode=410&dataKey=UNIT&commandCodes=$commandCode",
                Get.context!,
              )
