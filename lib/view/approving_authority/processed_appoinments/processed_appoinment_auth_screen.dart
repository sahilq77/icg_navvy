...
import '../../../controller/approving_auth/processed_appoinment/processed_appoinment_auth_conroller.dart';
...
class ProcessedAppoinmentAuthScreen extends StatefulWidget {
  @override
  State<ProcessedAppoinmentAuthScreen> createState() =>
      _ProcessedAppoinmentAuthScreenState();
}

class _ProcessedAppoinmentAuthScreenState
    extends State<ProcessedAppoinmentAuthScreen> {
  final ProcessedAppoinmentAuthConroller controller = Get.put(
    ProcessedAppoinmentAuthConroller(),
  );
