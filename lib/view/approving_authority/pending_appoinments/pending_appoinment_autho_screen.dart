...
import 'package:icg_navy/controller/approving_auth/pending_appoinment/pending_appoinment_auth_controller.dart';
...
class PendingAppoinmentAuthoScreen extends StatefulWidget {
  @override
  State<PendingAppoinmentAuthoScreen> createState() =>
      _PendingAppoinmentAuthoScreenState();
}

class _PendingAppoinmentAuthoScreenState
    extends State<PendingAppoinmentAuthoScreen> {
  final PendingAppoinmentAuthController controller = Get.put(
    PendingAppoinmentAuthController(),
  );
